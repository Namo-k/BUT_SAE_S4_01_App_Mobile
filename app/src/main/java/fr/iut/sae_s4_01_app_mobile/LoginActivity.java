        ...
        loginBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (DatabaseIdentifiant.checkEmailPassword(usernameCo, passwordCo )) {
                    ...
                    Intent intent;  // page apres co

                    if(usernameCo.equals("admin@gmail.com") && passwordCo.equals("Codeadmin77!!")){
                        intent = new Intent(LoginActivity.this, AccueilAdminActivity.class); // page apres co
                    }else{
                        intent = new Intent(LoginActivity.this, MainActivity.class); // page apres co
                    }
